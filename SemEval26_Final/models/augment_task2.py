"""
Data Augmentation for Task 2: Evasion Classification (9 classes)
...
def augment():
    logger.log("TASK 2: EVASION - DATA AUGMENTATION (9 CLASSES)", "announce")
    ...
    if not os.path.exists(raw_path):
        ...
        logger.log("This should contain evasion_label or label column", "warning")
        return
    ...
    if "evasion_label" in df.columns:
        ...
        logger.log("No evasion_label or label column found!", "error")
        return
    ...
    output_path = os.path.join(DATASET_PATH, "task2_train.parquet")
    output_csv_path = os.path.join(DATASET_PATH, "task2_train.csv")
